% cryptotech(SECTION) | User Commands
%
% "August 22 2022"
...
cryptotech - program to do something

# SYNOPSIS

**cryptotech** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**cryptotech** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **cryptotech** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**cryptotech** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    cryptotech. See **foo.conf**(5) for further details.
...
**cryptotech** provides some return codes, that can be used in scripts:
...
sadava <info@cryptotech.ee>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 sadava
